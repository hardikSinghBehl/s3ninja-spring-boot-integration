package com.behl.emulator.controller;
...
import com.behl.emulator.service.StorageService;
...
public class StorageController {
	...
	public ResponseEntity<InputStreamResource> retrive(
		...
		return ResponseEntity.status(HttpStatus.OK)
				.header(HttpHeaders.CONTENT_DISPOSITION, "attachment;filename=" + retrievedObject.getKey())
